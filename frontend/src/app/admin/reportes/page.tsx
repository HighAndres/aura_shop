      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between animate-fade-in">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            {isAdmin
              ? "Resumen completo de ventas, métricas e inventario"
              : "Resumen de actividad y productos"}
          </p>
        </div>
          ...
          <>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
              ...
              <StatCard
                ...
                subtitle="En el periodo (sin cancelados)"
                icon={ShoppingCart}
            ...
            {/* Gráfico de ventas diarias — visual bar chart */}
            ...
            {/* Tabla de ventas diarias detallada — admin/superadmin */}
            {isAdmin && ventas.ventas_diarias.length > 0 && (
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-6">
              ...
              {isAdmin ? (
                ...
                <StatCard
                  ...
                  value={inventario.movimientos_recientes}
